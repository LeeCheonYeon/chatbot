    ...
    response = ollama_client.chat(model=OLLAMA_MODEL, messages=[
            {
                ...
                "content": (
                    ...
                    "9. 출력 단계 (성공): 맞춤법, 한글 문법에 맞게 답변한다.\n"
                    "10. 출력 단계 (실패): 자료에 직접적인 정보가 없거나, 질문이 자료와 관련 없다면 오직 '정보를 찾을 수 없습니다.' 한 문장만 출력한다.\n"
                    "11. 데이터를 분석해서 답변을 해야한다. 절대 데이터를 짜집기 하지 마라\n"
            )
            },
            {
                'role': 'user',
